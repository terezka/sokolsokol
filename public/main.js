	...
	return elm$core$Platform$Sub$batch(
		_List_fromArray(
			[
				...
				author$project$Ports$receiveArticle(author$project$Main$GotArticle),
				function () {
				var _n0 = model.page;
				switch (_n0.$) {
					case 'Admin':
...
var author$project$Page$Article$GotFiles = F2(
	function (a, b) {
...
var author$project$Main$update = F2(
	function (message, model) {
		switch (message.$) {
			...
			case 'GotArticle':
				var value = message.a;
				var _n4 = A2(elm$json$Json$Decode$decodeValue, author$project$Data$Article$decodeOne, value);
				if (_n4.$ === 'Ok') {
					var article = _n4.a;
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								session: A2(author$project$Session$setArticle, article, model.session)
							}),
						elm$core$Platform$Cmd$none);
				} else {
					return _Utils_Tuple2(model, elm$core$Platform$Cmd$none);
			...
			[
				...
				_List_fromArray(
					[
						...
						rtfeldman$elm_css$Html$Styled$Events$onClick(author$project$Page$Article$Toggle)
					]),
				_List_fromArray(
					[
...
var author$project$Page$Skeleton$styles = _List_fromArray(
	[
		rtfeldman$elm_css$Css$Global$body(
		_List_fromArray(
			[
				A2(rtfeldman$elm_css$Css$property, 'font-family', '-apple-system, BlinkMacSystemFont, \'Segoe UI\', Roboto, Helvetica, Arial, sans-serif, \'Apple Color Emoji\', \'Segoe UI Emoji\', \'Segoe UI Symbol\''),
...
var rtfeldman$elm_css$Html$Styled$menu = rtfeldman$elm_css$Html$Styled$node('menu');
	...
	function (toMsg, session, document) {
		return {
			body: A2(
				...
				_List_fromArray(
					[
						rtfeldman$elm_css$Css$Global$global(author$project$Page$Skeleton$styles),
						A2(
						rtfeldman$elm_css$Html$Styled$menu,
						_List_fromArray(
							[
								rtfeldman$elm_css$Html$Styled$Attributes$css(
								_List_fromArray(
...
_Platform_export({'Main':{'init':author$project$Main$main(
	elm$json$Json$Decode$succeed(_Utils_Tuple0))({"versions":{"elm":"0.19.0"},"types":{"message":"Main.Msg","aliases":{"Url.Url":{"args":[],"type":"{ protocol : Url.Protocol, host : String.String, port_ : Maybe.Maybe Basics.Int, path : String.String, query : Maybe.Maybe String.String, fragment : Maybe.Maybe String.String }"}},"unions":{"Main.Msg":{"args":[],"tags":{"NoOp":[],"LinkClicked":["Browser.UrlRequest"],"UrlChanged":["Url.Url"],"OnAuthChange":["Json.Encode.Value"],"GotArticles":["Json.Encode.Value"],"GotArticle":["Json.Encode.Value"],"ArticlesMsg":["Page.Articles.Msg"],"ArticleMsg":["Page.Article.Msg"],"AdminMsg":["Page.Admin.Msg"]}},"Page.Admin.Msg":{"args":[],"tags":{"UpdateEmail":["String.String"],"UpdatePassword":["String.String"],"Submit":[],"GotError":["Json.Encode.Value"]}},"Page.Article.Msg":{"args":[],"tags":{"Toggle":[],"Pick":[],"GotFiles":["File.File","List.List File.File"],"GotFileUrl":["String.String","String.String"],"GotFileDownloadUrl":["Json.Encode.Value"]}},"Page.Articles.Msg":{"args":[],"tags":{"Msg":[]}},"Browser.UrlRequest":{"args":[],"tags":{"Internal":["Url.Url"],"External":["String.String"]}},"Basics.Int":{"args":[],"tags":{"Int":[]}},"Maybe.Maybe":{"args":["a"],"tags":{"Just":["a"],"Nothing":[]}},"String.String":{"args":[],"tags":{"String":[]}},"Json.Encode.Value":{"args":[],"tags":{"Value":[]}},"Url.Protocol":{"args":[],"tags":{"Http":[],"Https":[]}},"List.List":{"args":["a"],"tags":{}},"File.File":{"args":[],"tags":{"File":[]}}}}})}});}(this));