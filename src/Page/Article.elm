...
view model =
    ...
    , body =
        [ Html.article
            ...
            [ Html.img [ Attr.src "https://spectrum.ieee.org/image/Mjc5MDM4Nw.jpeg", Attr.css [ Css.width (Css.pct 100) ] ] [] , Html.h1 [ Attr.css [ Css.textDecoration Css.overline ] ] [ Html.text "Kafka, Civilization, and Bureaucracy" ]
